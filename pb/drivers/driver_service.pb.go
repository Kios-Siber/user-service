...
var file_drivers_driver_service_proto_rawDesc = []byte{
	...
	,
...
var file_drivers_driver_service_proto_goTypes = []interface{}{
	...
	(*Driver)(nil),              // 1: ksuser.Driver
	(*generic.Id)(nil),          // 2: ksuser.Id
	(*Drivers)(nil),             // 3: ksuser.Drivers
	(*generic.BoolMessage)(nil), // 4: ksuser.BoolMessage
}
var file_drivers_driver_service_proto_depIdxs = []int32{
	0, // 0: ksuser.DriversService.List:input_type -> ksuser.DriverListInput
	1, // 1: ksuser.DriversService.Create:input_type -> ksuser.Driver
	1, // 2: ksuser.DriversService.Update:input_type -> ksuser.Driver
	2, // 3: ksuser.DriversService.Delete:input_type -> ksuser.Id
	3, // 4: ksuser.DriversService.List:output_type -> ksuser.Drivers
	1, // 5: ksuser.DriversService.Create:output_type -> ksuser.Driver
	1, // 6: ksuser.DriversService.Update:output_type -> ksuser.Driver
	4, // 7: ksuser.DriversService.Delete:output_type -> ksuser.BoolMessage
...
func (c *driversServiceClient) List(ctx context.Context, in *DriverListInput, opts ...grpc.CallOption) (*Drivers, error) {
	out := new(Drivers)
	err := c.cc.Invoke(ctx, "/ksuser.DriversService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *driversServiceClient) Create(ctx context.Context, in *Driver, opts ...grpc.CallOption) (*Driver, error) {
	out := new(Driver)
	err := c.cc.Invoke(ctx, "/ksuser.DriversService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *driversServiceClient) Update(ctx context.Context, in *Driver, opts ...grpc.CallOption) (*Driver, error) {
	out := new(Driver)
	err := c.cc.Invoke(ctx, "/ksuser.DriversService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *driversServiceClient) Delete(ctx context.Context, in *generic.Id, opts ...grpc.CallOption) (*generic.BoolMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/ksuser.DriversService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DriversService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ksuser.DriversService/List",
	}
...
func _DriversService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ksuser.DriversService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DriversService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ksuser.DriversService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DriversService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ksuser.DriversService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _DriversService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ksuser.DriversService",
